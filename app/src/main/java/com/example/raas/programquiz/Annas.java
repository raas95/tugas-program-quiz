...
public class Annas extends AppCompatActivity {
    ...
    void prepareData(){
        setQuestion("potongan ayat berikut ini إِلٰهِ النَّاسِ merupakan ayat ke berapa?", "ke-1", "ke-6", "ke-3", "ke-4", "C");
        setQuestion("potongan ayat berikut ini مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ merupakan ayat ke berapa?", "ke-1", "ke-2", "ke-3", "ke-4", "D");
        setQuestion("potongan ayat berikut ini مَلِكِ النَّاسِْ merupakan ayat ke berapa?", "ke-1", "ke-2", "ke-3", "ke-5", "B");
        setQuestion("potongan ayat berikut ini مِنَ الْجِنَّةِ وَالنَّاسِ  merupakan ayat ke berapa?", "ke-5", "ke-2", "ke-3", "ke-6", "D");
        setQuestion("potongan ayat berikut ini الَّذِى يُوَسْوِسُ فِى صُدُورِ النَّاسِ  merupakan ayat ke berapa?", "ke-1", "ke-2", "ke-5", "ke-4", "C");
        setQuestion("potongan ayat berikut ini قُلْ أَعُوذُ بِرَبِّ النَّاسِ  merupakan ayat ke berapa?", "ke-1", "ke-6", "ke-3", "ke-4", "A");
    ...
    void checkAnswer(){
        ...
        if(index == selectedAnsewer){
            ...
            if (a==7){
                Intent i = new Intent(Annas.this, Isi.class);
